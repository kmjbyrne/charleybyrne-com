...
The wince has a rather human explanation, mind you. Nobody is born liking
tannin; bitterness only turns pleasant after enough exposure, so a taste for dry
reds is mostly proof that the training happened. And preferences that take years
to acquire have a way of becoming badges for the people who acquired them. The
French sociologist Pierre Bourdieu wrote a whole book on exactly this,
[_Distinction_](https://en.wikipedia.org/wiki/Distinction_%28book%29), taste
operating as a marker of class. Quoting him here is, I am aware, precisely the
sort of badge-polishing he was describing, but the line is too good to leave
out: taste classifies, and it classifies the classifier.

<!-- prettier-ignore -->
::RelatedPost{path="https://en.wikipedia.org/wiki/Distinction_%28book%29" title="Distinction: A Social Critique of the Judgement of Taste"}
::
...
some fermented oddity from a third all crowded onto the same supermarket shelf.
Our palates are schooled by more of that collision than anyone before us, which
